...
description: Publish Markdown articles to Juejin (稀土掘金) using playwright-cli automation. Use when the user wants to publish articles to Juejin, especially when they provide a Markdown file path. Handles title, content, tags, cover image, category, and publication settings automatically.
---
...
Common tags: AI编程, 人工智能, Codex, AI工具
