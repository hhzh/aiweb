---
name: infoq-publisher
description: Publish Markdown articles to the InfoQ writing community using playwright-cli automation. Use when the user wants to publish articles to InfoQ, especially when they provide a Markdown file path. Handles title, content, tags, cover settings, and publication settings automatically.
---
