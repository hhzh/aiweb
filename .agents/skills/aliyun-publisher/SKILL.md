---
name: aliyun-publisher
description: Publish Markdown articles to Aliyun Developer Community using playwright-cli automation. Use when the user wants to publish articles to Aliyun, especially when they provide a Markdown file path. Handles title, content, tags, and publication settings automatically.
---
