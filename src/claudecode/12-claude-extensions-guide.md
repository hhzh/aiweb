...
Claude Code 作为具备代码推理能力的智能工具，内置文件操作、搜索、执行、网络访问等基础功能，可覆盖大多数日常编码任务。为满足个性化开发需求、对接外部服务及自动化工作流，其提供了丰富的扩展层能力。本手册将详细介绍 Claude Code 核心扩展功能的选型逻辑与配置要点，帮助开发者高效利用扩展能力，在控制上下文成本的同时，实现工作流的优化与定制。
...
Claude Code 扩展功能的核心价值的是“按需定制、高效协同”，选型与配置的关键在于“匹配场景、控制成本”。开发者应遵循“先核心后扩展、先简单后复杂”的原则，从 CLAUDE.md 入手，逐步添加 Skills、MCP 等扩展，结合实际需求组合使用，避免盲目配置。

本手册覆盖了核心扩展的选型逻辑、配置要点与组合方式，可作为日常开发中扩展配置的参考指南。实际使用中，需结合项目特点灵活调整，平衡功能需求与上下文成本，让扩展能力真正服务于开发效率的提升。
