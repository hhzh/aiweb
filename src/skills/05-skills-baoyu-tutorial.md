...
本文基于官方文档整理，覆盖**环境准备、安装更新、核心技能使用、API 配置、个性化自定义**全流程，新手也能快速上手。
...
baoyu-skills 把 Claude Code 从纯文本对话工具，升级为**一站式多媒体内容创作平台**，尤其适合中文场景的自媒体运营、知识科普、技术文档、商务演示等场景。

从文本到可视化内容、从创作到发布全链路自动化，无需设计、剪辑、排版基础，即可产出专业级内容，是 AI 时代提升效率的必备工具集。
