...
Hermes Agent 插件系统是**模块化扩展核心能力**的关键机制，无需修改框架源码，即可自定义工具、事件钩子、命令与集成能力。插件遵循 “**低侵入、高兼容、可插拔**” 设计，支持用户自定义、项目专属、官方内置三类插件，覆盖工具扩展、流程自动化、第三方集成等全场景。本文从核心概念、插件管理、开发入门、内置插件、最佳实践五方面，带你全面掌握插件使用与开发。
